    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.IntegerField(default=0, verbose_name='区域等级')),
            ],
            options={
                'verbose_name': '地区表',
                'db_table': 'area',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='所属用')),
            ],
            options={
                'verbose_name': '收货地址表',
                'db_table': 'addr',
